            ...
            <tr>
              ...
              <td>
                <ul class="d-flex justify-content-center">
                  ...
                  <li><a href="#" class="text-danger "data-toggle="modal" data-target="#modal-danger" data-orderid="{{$cat->id}}" data-name="{{$cat->user->name}}">
            ...
            <div class="modal  fade" id="modal-danger">
              <div class="modal-dialog modal-sm">
                <div class="modal-content">
                  ...
                  <form action="/deleteorder/{{$cat->id}}" method="POST">
                    {{ csrf_field() }}
                    {{ method_field('delete') }}
                    <div class="modal-body">
                      <p>Are  You  Sure  to  Delete This Order of</p>
