          ...
          <div class="col-sm-8">
            <div class="shop-menu pull-right">
              <ul class="nav navbar-nav">
                ...
                @else
                <li class="nav-item"><a href="/" class="nav-link {{ '/' == request()->path() ? 'active' : '' }}" class="nav-link">Home</a></li>
                <li class="nav-item"><a href="/cart" class="nav-link {{ 'cart' == request()->path() ? 'active' : '' }}" class="nav-link"><i class="fa fa-shopping-cart"></i> My Cart ({{(int)App\Cart::first()->totalItems() }})</a>
                </li>
