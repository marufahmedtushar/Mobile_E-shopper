                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">@yield('name')</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="/dashboard">Home</a></li>
                                <li><a href="/" ><span class="badge badge-pill  font-weight-bold text-light" style="background-color: #881DFD;">Go To E-Shopper</span></a></li>
                            </ul>
                        </div>
                    </div>
